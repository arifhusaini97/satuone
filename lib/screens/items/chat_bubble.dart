...
class ChatBubble extends StatefulWidget {
  final String message, time, name, type, replyText, replyName, username;
...
class _ChatBubbleState extends State<ChatBubble> {
  ...
  Widget build(BuildContext context) {
    final bg = widget.isMe ? Theme.of(context).accentColor : Colors.white;
    //final bg = widget.isMe ? Colors.purple[100] : Colors.white;
    final align =
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                  "${widget.username}",
                  style: TextStyle(
                    color: randomColors[random.nextInt(10)],
                  ),
                ),
              ),
              SizedBox(height: 5.0),
              ...
              widget.isReply
                  ? Container(
                      decoration: BoxDecoration(
                        color:
                            !widget.isMe ? Colors.grey[300] : Colors.blue[50],
                        borderRadius: BorderRadius.all(Radius.circular(5.0)),
                      ),
                      constraints: BoxConstraints(
                        minHeight: 25,
